      ...
      <tbody>
        ...
        {videos?.map((video, index) => (
          ...
          >
            <td className="p-2 px-8 ">
              <section className="flex gap-2 ">
                ...
                <div className="text-[.75rem] text-zinc-300 mt-3 relative flex-grow">
                  ...
                  >
                    <NavLink to={`/video-update/${video?._id}`} className=" p-2 cursor-pointer rounded-full text-xl hover:bg-[#353535]">
                      <MdOutlineEdit />
                    </NavLink>
            ...
            <td className="p-2 px-8 align-text-top pt-3">{video?.createdAt.slice(0, 10).split("-").reverse().join("-")}</td>
