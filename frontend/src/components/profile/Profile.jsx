...
function Profile({ user }) {
  ...
  return (
    <section className=" flex flex-col justify-normal px-4 h-full">
        ...
        <div className="mt-8">
          <section onClick={handleFeatureSoonShow} className="hover:bg-[#1f1f1f] rounded-lg p-2 px-3 flex items-center gap-2 cursor-pointer">
            <LuLayoutDashboard className="text-xl" />
            <h1 className="text-[1rem] font-semibold">Dashboard</h1>
          </section>
          <NavLink to="#" className={({isActive}) =>  `${isActive ? "bg-[#1f1f1f]" : ""} hover:bg-[#1f1f1f] mt-1 rounded-lg p-2 px-3 flex items-center gap-2`}>
        ...
        <div className="mt-auto">
          <section onClick={handleFeatureSoonShow} className="cursor-pointer hover:bg-[#1f1f1f] rounded-lg p-2 px-3 flex items-center gap-2">
